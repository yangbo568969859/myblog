<template>
  ...
  >
    <div class="fix-top-stack">
      ...
      <table-title title="已铺货数据" class="anchor-supplier"></table-title>
...
export default {
  data() {
    return {
      ...
      columns2: [
        { title: '平台店铺', dataIndex: 'name'},
        { title: '铺货数', dataIndex: 'quantity', sorter: true},
        { title: '总货值', scopedSlots: { customRender: 'worth' }, sorter: true},
      ],
    }
  },
  mounted() {
