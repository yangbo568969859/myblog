...
<script>
import { yAxis, xAxis, tooltip, Option2 } from '@/constants/echart';
export default {
  data() {
    return {
      headerData: [
      ...
      columns2: [
        ...
        { title: '待发货', dataIndex: 'add', scopedSlots: { customRender: 'add' }},
        { title: '采购成功', dataIndex: 'now', scopedSlots: { customRender: 'now' }, sorter: true},
        { title: '交易失败', dataIndex: 'quantity', sorter: true},
        { title: '采购总数', dataIndex: 'fail', sorter: true },
        { title: '总货值', scopedSlots: { customRender: 'worth' }},
      ],
    }
  },
  mounted() {
